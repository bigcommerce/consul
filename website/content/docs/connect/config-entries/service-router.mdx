...
Mirror traffic matching this route to another service, discarding the reply. Review the [`ServiceRouteDestinationMirror`](#serviceroutedestinationmirror) block for more details.
...
<ConfigEntryReference
  ...
  keys={[
    ...
    {
      name: 'MirrorPolicy',
      type: 'ServiceRouteDestinationMirror: <optional>',
      description: `A [traffic mirroring policy](/docs/connect/config-entries/service-router#serviceroutedestinationmirror) to allow
      a percentage of traffic matching this route to be mirrored to another service (replies are discarded)
      This cannot be used with a \`tcp\` listener.`,
    },
  ]}
/>
  ...
  keys={[
    {
      ...
      type: 'string: ""',
      description:
        'The service to mirror traffic to.',
    },
    {
      name: 'ServiceSubset',
      type: 'string: ""',
      description: 'A named subset of the given service to mirror traffic to.',
    },
    {
      name: 'Namespace',
      type: 'string: ""',
      description:
        'The Consul namespace to resolve the mirror service from instead of the current namespace. If empty, the current namespace is used.',
      enterprise: true,
    },
    {
      name: 'Partition',
      type: 'string: ""',
      description:
        'The Consul admin partition to resolve the mirror service from instead of the current partition. If empty, the current partition is used.',
      enterprise: true,
    },
    {
      name: 'Percent',
      type: 'int: 100',
      description: 'The percentage of traffic to be mirrored to this service',
    },
  ]}
/>
